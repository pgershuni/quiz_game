...
response = requests.post('http://127.0.0.1:8080/api/tests', json={'title': 'Тест', 'category': 'Химия',
              ...
              'questions': [
                {'type': 'ord',
                 ...
                 'answer': 'ответ'},
                {'type': 'rad',
                 'question': ['сам вопрос', ['вариант1', 'правильный вариант', 'варианты2']],
                 'answer':'правильный вариант'},
                {'type': 'check',
                 'question': ['сам вопрос', ['вариант1 правильный', 'вариант2', 'вариант3 правильный',
                                             'вариант3', 'вариант4']],
                 'answer':['вариант1 правильный', 'вариант3 правильный']}],
              'is_private': False,
              'user_id': 1})
print(response.json())